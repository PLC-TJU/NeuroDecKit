...
class RAVE(BaseEstimator, ClassifierMixin):
    def __init__(self,
                 fs_new=250,
                 timesets=[[0, 2],[0.5, 2.5],[1, 3],[1.5, 3.5],[2, 4]],
        ...
        for channels, time_window, freq_window in self.parasets:
            ...
            Model = TL_Classifier(dpa_method='RA', 
                                  fee_method='MDM', 
                                  fes_method=None,
                                  clf_method=None, 
                                  end_method=None, 
                                  ete_method=None, 
                                  pre_est=pre_processor, 
    ...
    def fit(self, X, y_enc):
        ...
        datas = []
        if self.target_domain in domains:
            data = {}
            test_index = domains.index(self.target_domain)
            train_index = [i for i in range(len(domains)) if i != test_index]
...
if __name__ == '__main__':
    ...
    for sub in subjects:
            ...
            Model = RAVE(target_domain=target_domain, njobs=-1)
